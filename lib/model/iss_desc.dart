const ISS_desc = "The International Space Station (ISS) is a modular space station (habitable artificial satellite) in low Earth orbit."
    ...
    " Roscosmos has endorsed the continued operation of ROS through 2024, having previously proposed using elements of the segment to construct a new Russian space station called OPSEK."
    ...
    " The station has since been continuously occupied for 20 years and 330 days, the longest continuous human presence in low Earth orbit, having surpassed the previous record of 9 years and 357 days held by the Mir space station. The latest major pressurised module, Nauka, was fitted in 2021, a little over ten years after the previous major addition, Leonardo in 2011."
    " Development and assembly of the station continues, with an experimental inflatable space habitat added in 2016, and several major new Russian elements scheduled for launch starting in 2021."
    " In December 2018, the station's operation authorization was extended to 2030, with funding secured until 2025."
    ...
    " The station is serviced by a variety of visiting spacecraft: the Russian Soyuz and Progress, the SpaceX Dragon 2, and the Northrop Grumman Space Systems Cygnus, and formerly the European Automated Transfer Vehicle (ATV), the Japanese H-II Transfer Vehicle, and SpaceX Dragon 1."
    ...
    " As of August 2021, 244 astronauts, cosmonauts, and space tourists from 19 different nations have visited the space station, many of them multiple times; this includes 153 Americans, 50 Russians, 9 Japanese, 8 Canadians, 5 Italians and 1 Brazilian.";