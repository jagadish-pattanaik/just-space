...
class AgeCalculator extends StatefulWidget {
  ...
  const AgeCalculator({Key key, @required this.screenSize}) : super(key: key);

  @override
  _AgeCalculatorState createState() => _AgeCalculatorState();
}

class _AgeCalculatorState extends State<AgeCalculator> with TickerProviderStateMixin {
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Column(
                              children: [
                                result != null && userInput.text != ''? Text(result + ' Years',
                                  maxLines: 1,
                                ...
                                TextField(
                                  ...
                                  onChanged: (val) {
                                    if (userInput.text != null && userInput.text != '') {
                                      setState(() {
                                        ...
                                        double y = double.tryParse(planets[preIndex].timesYear.toString());
                                        double r = x/y;
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Your age on Earth in years?',
                                    ...
                                    onIndexChanged: (i) {
                                      if (userInput.text != null && userInput.text != '') {
                                        setState(() {
                                          preIndex = i;
                                          double x = double.tryParse(userInput.text);
                                          double y = double.tryParse(planets[i].timesYear.toString());
                                          double r = x/y;
                                          result =  r.toStringAsFixed(1);
                                        });
                                      } else {
